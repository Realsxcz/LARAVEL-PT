...
<body>
    ...
    <form class="form" method="post" action="{{route('Register-User')}}">
        ...
        @endif
        @csrf
        <h1 style="text-align: left;color: #666; margin-top: 0%; font-size: 30px; font-weight: 300;">New Data?</h1>
        ...
        <button type=button onClick="location.href='{{ url('/Homepage') }}'" class="button1">Go Back</button>
    </form>
